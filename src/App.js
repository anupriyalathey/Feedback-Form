...
class App extends Component {
  ...
  componentDidMount() {
    // Fetch feedback questions and choices from the API
    fetch('https://brijfeedback.pythonanywhere.com/api/get-feedback-questions/?unitID=1')
      ...
      .then(data => {
        ...
        questions.forEach((question, index) => {
          selectedChoices[question] = choices[index][0]; // Default selection
        });
  ...
  handleSubmit = () => {
    ...
    // You can send the feedback data to the backend here if needed
  };
